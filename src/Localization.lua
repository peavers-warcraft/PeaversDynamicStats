...
Locales["enUS"] = {
    ...
    ["CONFIG_RESET_POSITION"] = "Reset Position",
    ["CONFIG_TROUBLESHOOTING"] = "Troubleshooting",
    ["CONFIG_RESET_POSITION_DESC"] = "If the stats frame has disappeared or moved off-screen, click this button to reset its position to the center of the screen and restore default visibility settings.",
...
Locales["zhCN"] = {
    ...
    ["CONFIG_RESET_POSITION"] = "重置位置",
    ["CONFIG_TROUBLESHOOTING"] = "故障排除",
    ["CONFIG_RESET_POSITION_DESC"] = "如果属性框架消失或移出屏幕，点击此按钮将其重置到屏幕中央并恢复默认可见性设置。",
...
Locales["zhTW"] = {
    ...
    ["CONFIG_RESET_POSITION"] = "重置位置",
    ["CONFIG_TROUBLESHOOTING"] = "疑難排解",
    ["CONFIG_RESET_POSITION_DESC"] = "如果屬性框架消失或移出螢幕，點擊此按鈕將其重置到螢幕中央並恢復預設可見性設定。",
...
Locales["koKR"] = {
    ...
    ["CONFIG_RESET_POSITION"] = "위치 초기화",
    ["CONFIG_TROUBLESHOOTING"] = "문제 해결",
    ["CONFIG_RESET_POSITION_DESC"] = "능력치 프레임이 사라지거나 화면 밖으로 이동한 경우, 이 버튼을 클릭하여 화면 중앙으로 위치를 초기화하고 기본 표시 설정을 복원합니다.",
